...
module coreBox() {
    union() {
        ...
        difference(){
            translate([0, 0, 0])
            rotate([90, 0, 0])
            cube([coreWidth, coreDepth, coreHeight], true);
            ...
            translate([25, 0, 0])
            union() {
                cylinder(coreDepth, d=25, $fn=180, center=true);                
                translate([10, 0, 0])
                cube([20, 25, coreDepth], true);
            }
        }
    }
}
...
module deckSpaces() {
    union() {
        ...
        translate([0, -deckDepth - 5, 0])
        cube([deckWidth, deckDepth, deckHeight], true);
        
        translate([0, -deckDepth * 2 + 20.5, 0])
        cube([deckWidth, 14, deckHeight], true);
    }
}
...
module insetRing() {
    difference() {
        union() {
            ...
            translate([0, 0, 4])
            cylinder(h=50, d=nukeDiameter+4.5, $fn=200);
            translate([0, 0, 50])
